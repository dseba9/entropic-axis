...
def plot_2d(stats_df, output_tag):
    ...
    ax.text(0.1, 0.1, "Wake", fontsize=15, fontweight="bold", ha="left", va="bottom")
    ...
    ax.set_xlabel("SE dFC (Z-Score)", fontsize=17, fontweight="bold")
    ax.set_ylabel("SE dSW (Z-Score)", fontsize=17, fontweight="bold")
