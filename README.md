...
4. **Small-World Propensity (SWP)** (Muldoon et al., 2016): Required for dSW. [Download from GitHub](https://github.com/dbs-upenn/small-world-propensity).
5. **Physionet Sample Entropy (sampen)**: Required for entropy. [Download from PhysioNet](https://physionet.org/content/sampen/1.0.0/).
...
* **Sebastián Alán Galvan** — [sebas.galvan@mi.unc.edu.ar](mailto:sebas.galvan@mi.unc.edu.ar)
